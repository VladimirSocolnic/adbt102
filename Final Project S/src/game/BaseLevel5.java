...
public class BaseLevel5 extends GameFundamentation {

    public BaseLevel5(Game game){
        ...
        getSamurai().addCollisionListener(new FinalObt(getSamurai()));
